...
class Questionnaire:
    ...
    def _is_correct_answer(self, question, user_answer):
        ...
        if is_multiple_choice:
            ...
            return remove_whitespace(correct_answer.lower()) == remove_whitespace(user_answer.lower())
...
class QuizApp:
    ...
    def _offer_practice_session(self):
        ...
        response = input("Would you like to practice your missed questions? (yes/no): ").strip().lower()
