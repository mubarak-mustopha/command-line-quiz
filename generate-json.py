...
if __name__=="__main__":
    ...
    parser.add_argument("--start", "-s", type=int, default=30, help="Page number to start parsing (default: 30)")
    parser.add_argument("--end", "-e", type=int, default=None, help="Page number to stop parsing (default: parse to end of document)")
    parser.add_argument("--pdf", "-p", type=str, default="./gns106+++.pdf", help="Path to PDF file to parse (default: ./gns106+++.pdf)")
    parser.add_argument("--output", "-o", type=str, default="gns-test.json", help="Path to output JSON file (default: gns-test.json)")

    args = parser.parse_args()

    questions = parse_pdf(args.pdf, PATTERN, args.start, args.end, func = get_q_and_a_dict)
